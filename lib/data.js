...
/* 
 * Function  	removes a meeting by the supplied @id
 * @id 			database _id of the meeting to remove, can be string, ObjectId(), or whatever monogoose takes 
 * returns	 	the removed meeting
 */
